...
contract AuctionSystem {
    ...
    function createAuction(
        ...
        require(_duration >= MINIMUM_DURATION, "Auction duration too short");
        require(_duration <= MAXIMUM_DURATION, "Auction duration too long");
        ...
        auctionActive(_auctionId)
    {
        ...
        uint256 minimumBid = auction.currentBid > 0 ? auction.currentBid : auction.startingPrice;
        require(msg.value > minimumBid, "Bid must be higher than current bid or starting price");
