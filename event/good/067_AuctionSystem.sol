...
contract AuctionSystem {
    ...
    modifier onlyActiveBidding(uint256 _auctionId) {
        ...
        require(!auctions[_auctionId].ended, "Auction already finalized");
        _;
    }
    ...
    function withdraw(uint256 _auctionId) external onlyValidAuction(_auctionId) {
    ...
    function isAuctionActive(uint256 _auctionId)
        ...
        returns (bool)
    {
        return block.timestamp < auctions[_auctionId].auctionEndTime && !auctions[_auctionId].ended;
    }
}
