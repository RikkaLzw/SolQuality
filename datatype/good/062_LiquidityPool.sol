...
contract LiquidityPool {
    ...
    function mint(address to) external lock returns (uint256 liquidity) {
        ...
        if (feeOn) kLast = bytes32(uint256(reserve0) * reserve1);
    ...
    function swap(uint256 amount0Out, uint256 amount1Out, address to, bytes calldata data) external lock {
        ...
        require(amount0In > 0 || amount1In > 0, 'LiquidityPool: INSUFFICIENT_INPUT_AMOUNT');
        {
            ...
            require(balance0Adjusted * balance1Adjusted >= uint256(_reserve0) * _reserve1 * 1000000, 'LiquidityPool: K');
        }
