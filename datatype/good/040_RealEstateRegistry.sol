...
contract RealEstateRegistry {
    ...
    event PropertyTransferred(bytes32 indexed propertyId, address indexed from, address indexed to, uint256 value);
    ...
    function transferProperty(
        ...
        emit PropertyTransferred(_propertyId, previousOwner, _newOwner, _transferValue);
    }
